...
import sliderimage from '../images/register-user-slider-image.png'
import { FcGoogle } from "react-icons/fc";
import { BsApple } from 'react-icons/bs';
import { Button } from 'react-bootstrap';
import { FaChevronDown } from "react-icons/fa";
const RegisterAsAuthor = ()=>{
  return (
    <>
    < div className='register-as-author login-page-section register-page-section '>
               ...
               <div className='slider-section'>
                    <Carousel>
                        ...
                        <div className="slider-data">
                           <img src={sliderimage} alt="Image"></img>
                           <div className='slider-content'>
                                <h3>Powerfull Dashboard</h3>
                                <p>Mahatma Gandhi written by Romain Rolland, a French novelist and Nobel Prize winner, presents the life and legacy ‘Mahatma Gandhi’ written by Romain Rolland, </p>
                           </div>
                        </div>
                        </Carousel.Item>
                        <Carousel.Item>
...
export default RegisterAsAuthor;