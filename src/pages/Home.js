    ...
    <>
      <section className="main-section">
        <div className="main-section-content">
          <h1>
            Once you peak inside our books,{" "}
            <span className="primary-color">you won't want to leave</span>
          </h1>
      ...
      <section className="book-offer-banner-design">
        <div className="container-large">
          <Carousel>
            <Carousel.Item>
              <div className="slider-data">
                <img src={bookofferbanner1} alt="Book Offer"></img>
              </div>
            </Carousel.Item>
            <Carousel.Item>
              <div className="slider-data">
                <img src={bookofferbanner2} alt="Book Offer"></img>
              </div>
            </Carousel.Item>
            <Carousel.Item>
              <div className="slider-data">
        ...
        <div className="container">
          <div className="trending-books-content">
            <div className="headng d-flex justify-content-between align-items-center">
              ...
              <div className="left-content">
                <a href="#" className="dark-blue ms-3 fw-500">
                  View All
                </a>
              </div>
            </div>
        ...
        <div className="container">
          <div className="publish-book-content d-flex justify-content-between align-items-center">
            <div className="left-part">
              ...
              <div className="btn-wrap">
                <button className="btn btn-white green-color">
                  Sign up as a Author
                </button>
              </div>
            </div>
            ...
            <ul className="client-review-list d-flex justify-content-between flex-wrap">
              <li>
                ...
                <div className="review-comment">
                  <h2>
                    Sigmud Freud -<span> CEO of Xyz company</span>
                  </h2>
                  <p>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                    do eiusmod tempor incididunt ipsum
                  </p>
                </div>
              </li>
              <li>
            ...
            <div className="right-part">
              ...
              <div className="btn-wrap">
                <button className="btn btn-white primary-color">
                  ...
                  >
                    <path
                      d="M23.5917 12.8973L18.8433 10.1548L13.9821 15.016L18.8429 19.8769L23.6078 17.1252C24.3508 16.6738 24.7942 15.8852 24.7942 15.016C24.7942 14.1468 24.3505 13.3582 23.5917 12.8973Z"
                      fill="#FFCE00"
                    />
                    <path
                      d="M13.9813 15.0155L0.740286 1.6792C0.279749 2.13974 6.10352e-05 2.76465 6.10352e-05 3.45546V26.5349C6.10352e-05 27.2257 0.279749 27.8506 0.740286 28.3115L13.9813 15.0155Z"
                      fill="url(#paint0_linear_177_51647)"
                    />
                    <path
                      d="M13.9816 15.0167L18.8428 10.1555L18.8505 10.1477L12.3371 6.39756L3.75092 1.35127C2.97775 0.874257 2.0402 0.857784 1.25056 1.30185C1.06971 1.41681 0.904978 1.53212 0.740601 1.68002L13.9816 15.0167Z"
                      fill="#00F076"
                    />
                    <path
                      d="M0.740601 28.312C0.904978 28.4599 1.06971 28.5752 1.25056 28.6902C1.6452 28.904 2.05667 29.0193 2.46779 29.0193C2.91186 29.0193 3.33945 28.8879 3.73445 28.6576L12.3368 23.6355L18.8502 19.8853L18.8425 19.8776L13.9816 15.0164L0.740601 28.312Z"
                      fill="#F63448"
                    />
                    <defs>
                      <linearGradient
                        id="paint0_linear_177_51647"
                        x1="-5.91753"
                        y1="21.6534"
                        x2="7.39846"
                        y2="8.33702"
                ...
                <button className="btn btn-white primary-color">
                  ...
                  >
                    <g clip-path="url(#clip0_177_51654)">
                      <path
                        d="M23.1664 0.983154H6.45727C3.32782 0.983154 0.794128 3.51684 0.794128 6.6463V23.3589C0.794128 26.4848 3.32782 29.0185 6.45727 29.0185H23.1699C26.2958 29.0185 28.833 26.4848 28.833 23.3554V6.6463C28.8295 3.51684 26.2958 0.983154 23.1664 0.983154Z"
                        fill="url(#paint0_linear_177_51654)"
                      />
                      <path
                        d="M14.6926 7.42545L15.2604 6.4442C15.6108 5.8309 16.3923 5.62417 17.0056 5.9746C17.6189 6.32503 17.8256 7.10651 17.4752 7.7198L12.0047 17.1888H15.9612C17.2438 17.1888 17.9622 18.6957 17.4051 19.74H5.80545C5.09758 19.74 4.52985 19.1723 4.52985 18.4644C4.52985 17.7565 5.09758 17.1888 5.80545 17.1888H9.05758L13.2209 9.97315L11.9207 7.7163C11.5703 7.103 11.777 6.32854 12.3903 5.9711C13.0036 5.62067 13.7781 5.8274 14.1355 6.44069L14.6926 7.42545Z"
                        fill="white"
                      />
                      <path
                        d="M9.77248 21.0552L8.54594 23.1823C8.19551 23.7956 7.41404 24.0024 6.80074 23.6519C6.18744 23.3015 5.98071 22.52 6.33114 21.9067L7.2423 20.3298C8.27256 20.0109 9.11012 20.2562 9.77248 21.0552Z"
                        fill="white"
                      />
                      <path
                        d="M20.3348 17.196H23.6535C24.3613 17.196 24.9291 17.7637 24.9291 18.4716C24.9291 19.1795 24.3613 19.7472 23.6535 19.7472H21.8101L23.0542 21.9059C23.4046 22.5192 23.1979 23.2937 22.5846 23.6511C21.9713 24.0016 21.1968 23.7948 20.8394 23.1815C18.7438 19.5474 17.1702 16.8281 16.1259 15.0163C15.0571 13.1729 15.8211 11.3226 16.5745 10.6953C17.4121 12.1321 18.6632 14.3014 20.3348 17.196Z"
                        fill="white"
                      />
                    </g>
                    <defs>
                      <linearGradient
                        id="paint0_linear_177_51654"
                        x1="14.8136"
                        y1="0.983154"
                        x2="14.8136"
                        y2="29.0185"
                      ...
                      <clipPath id="clip0_177_51654">
                        <rect
                          ...
                          height="28.0389"
                          fill="white"
                          transform="translate(0.794128 0.980469)"
                        />
                      </clipPath>
                    </defs>
                  </svg>
